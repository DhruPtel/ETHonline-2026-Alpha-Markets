...
export interface ProtocolConfig {
  ...
  /**
   * ⚠️ `null` on every row, including the five we have queried. `lendingType` is a field on the
   * live `LendingProtocol` entity and does NOT appear in `deployment.json` anywhere; SM-02
   * queried name, schemaVersion and balances, not this. Filling it from domain knowledge would
   * be exactly the guessing this table exists to prevent. The sweep fills it.
   */
...
export const PROTOCOLS: readonly ProtocolConfig[] = [
  ...
  { slug: 'aave-amm-ethereum', subgraphId: '41ooPWnDYKwckqyG1mvg7ZEndy5zMemXinx6uQxscrBS',
    network: 'ethereum', declaredSchemaVersion: '3.1.0', lendingType: null,
    liveSchemaVersion: '3.1.0',
    revenueAvailability: null, semanticNotes: null, corroborationHint: null,
    status: 'live', lastSwept: '2026-09-07' },
  ...
  { slug: 'abracadabra-ethereum', subgraphId: 'GLAu42kvVs7ixfXcmkAsRiS7Xt1NCpgkKsnz3qiriuvV',
    ...
    revenueAvailability: null, semanticNotes: null, corroborationHint: null,
    status: 'no_indexers', lastSwept: '2026-09-07' },
  ...
  { slug: 'inverse-finance-ethereum', subgraphId: 'EXuutY6qkZbXjYeJZdiDBf2imJswTNdfm8YZCqhAthfW',
    ...
    liveSchemaVersion: null,
    revenueAvailability: null, semanticNotes: null, corroborationHint: null,
    status: 'error', lastSwept: '2026-09-07' },
